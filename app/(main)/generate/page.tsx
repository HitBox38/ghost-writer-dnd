          ...
          <CardContent className="pt-6 space-y-4">
            <div className="space-y-2">
              ...
              <Tabs
                ...
                onValueChange={(v) => handleGenerationTypeChange(v as typeof generationType)}>
              ...
              <Select
                ...
                onValueChange={(v) =>
                  updateSettings({
                    ...
                    model: MODEL_OPTIONS[v as AIProvider][0].value,
                  })
                }>
        ...
        <Card>
          ...
          <CardContent>
            {results.length === 0 ? (
              ...
              <ScrollArea className="h-[calc(100vh-20rem)] w-full rounded-md space-y-4">
                        ...
                        <Button
                          ...
                          <Heart
                            className={`h-3.5 w-3.5 ${
                              favorites.has(result.id) ? "fill-red-500 text-red-500" : ""
                            }`}
                          />
                        </Button>
                        <Button
